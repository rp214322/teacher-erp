...
var userTable = $('#MiscBookingsTable').DataTable({
    ...
    columns: [
        ...
        {data: 'services_date', name: 'services_date',orderable:true},
        {data: 'services_time', name: 'services_time',orderable: true},
...
jQuery(function(){
    var m=document.getElementById('MiscBookingModel'),table=document.getElementById('MiscBookingsTable');
    var rack_types = {
        init: function() {
            jQuery(document).on('click','.btn-submit_misc',function(e){
            ...
            jQuery(document).on('click','.fill_data_misc',function(e){
                //jQuery('.pre-loader').show();
                var _this = jQuery(this);
                e.preventDefault();
                rack_types.fire(_this,"fetch");
            });
            jQuery(document).on('click',".btn-delete_misc",function(e){
                //jQuery('.pre-loader').show();
                var _this = jQuery(this);
                e.preventDefault();
