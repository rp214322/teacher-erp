...
// Hotel
var userTable = $('#HotelBookingsTable').DataTable({
    ...
    columns: [
        ...
        {data: 'hotel', name: 'hotel.name', orderable:true},
        {data: 'check_in', name: 'check_in', orderable:true},
        {data: 'check_out', name: 'check_out', orderable: true},
        {data: 'no_of_rooms', name: 'no_of_rooms', orderable: true},
        {data: 'type', name: 'type', orderable: true},
        {data: 'meal_plan', name: 'meal_plan', orderable: true},
        {data: 'voucher_ref', name: 'voucher_ref', orderable: true},
...
jQuery(function(){
    var m=document.getElementById('HotelBookingModel'),table=document.getElementById('HotelBookingsTable');
    var rack_types = {
        init: function() {
            jQuery(document).on('click','.btn-submit_hotel',function(e){
            ...
            jQuery(document).on('click','.fill_data_hotel',function(e){
                jQuery('.pre-loader').show();
                var _this = jQuery(this);
                e.preventDefault();
                rack_types.fire(_this,"fetch");
            });
            jQuery(document).on('click',".btn-delete_hotel",function(e){
                //jQuery('.pre-loader').show();
                var _this = jQuery(this);
                e.preventDefault();
