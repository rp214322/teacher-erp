...
var userTable = $('#TourBookingsTable').DataTable({
    ...
    columns: [
        ...
        {data: 'tour', name: 'tour.name',orderable:true},
        {data: 'tour_date', name: 'tour_date',orderable:true},
        {data: 'tour_time', name: 'tour_time',orderable: true},
        {data: 'no_of_passengers', name: 'no_of_passengers',orderable: true},
...
jQuery(function(){
    var m=document.getElementById('TourBookingModel'),table=document.getElementById('TourBookingsTable');
    var rack_types = {
        init: function() {
            jQuery(document).on('click','.btn-submit_tour',function(e){
            ...
            jQuery(document).on('click','.fill_data_tour',function(e){
                //jQuery('.pre-loader').show();
                var _this = jQuery(this);
                e.preventDefault();
                rack_types.fire(_this,"fetch");
            });
            jQuery(document).on('click',".btn-delete_tour",function(e){
                //jQuery('.pre-loader').show();
                var _this = jQuery(this);
                e.preventDefault();
