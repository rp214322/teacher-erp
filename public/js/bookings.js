...
var userTable = $('#BookingsTable').DataTable({
    ...
    columns: [
        ...
        {data: 'agent', name: 'agent.agency_name',orderable:true},
...
jQuery(function(){
    var m=document.getElementById('BookingModel'),table=document.getElementById('BookingsTable');
    var rack_types = {
        init: function() {
