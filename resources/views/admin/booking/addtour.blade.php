<form id="editable-form" action="{{ route('admin.tourbooking.store', ['booking_id' => $booking->id]) }}" method="POST">
    @csrf
    ...
    <div class="modal-body">
        <div class="modal_form">
            ...
            <div class="form-group row">
                <label for="tour-city" class="col-sm-3 col-form-label">City</label>
                <div class="col-sm-9">
                    <input type="text" id="city-id" name="city_id" class="form-control"
                        placeholder="Ahmedabad" readonly>
                </div>
            </div>
            <div class="form-group row">
                <label for="tour-date" class="col-sm-3 col-form-label">Tour Date</label>
                <div class="col-sm-9">
                    <input type="date" id="tour_date" name="tour_date" class="form-control" placeholder="30-03-2024"
                        required>
                </div>
            </div>
            <div class="form-group row">
